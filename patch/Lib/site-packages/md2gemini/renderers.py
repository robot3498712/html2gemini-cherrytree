...
class GeminiRenderer(
    ...
    def link(self, text=None, link=None, title=None, url=None, **kwargs):
        # Mistune 3 passes url=..., Mistune 2 passes link as first arg
        if link is None:
            link = url
    ...
    def list_item(self, text, level=1, **kwargs):
    ...
    def list(self, text, ordered, level=1, start=None, depth=None, **kwargs):
